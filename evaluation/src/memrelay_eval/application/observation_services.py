...
def verified_product_observation_evidence(
    ...
    *,
    ...
    manifest_records = run.manifest_records if native_receipt_persisted else ()
    reconciled = (
    ...
    reconciliation_records = run.reconciliation_records if reconciled else ()
...
def _telemetry_failure_reasons(
    ...
    if "TEL-DUPLICATE" in failure_codes:
    ...
    if "TEL-OUT-OF-ORDER" in failure_codes:
